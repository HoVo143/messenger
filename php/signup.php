        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            if(mysqli_num_rows($sql) > 0){
                ...
                if(isset($_FILES['image'])){ //if file is uploaded
                    ...
                    //let's explode image and get the last extension like jph png
                    ...
                    if(in_array($img_ext, $extensions) === true){ //if user uploaded img ext is matched with any array extensions
                        ...
                        if(move_uploaded_file($tmp_name, "images/".$new_img_name)){//if user upload img move to our folder successfuly
